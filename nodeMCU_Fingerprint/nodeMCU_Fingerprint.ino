...
#define Finger_Rx 3 //D5
#define Finger_Tx 1 //D6
...
const char *ssid = "DEEB";  //ENTER YOUR WIFI SETTINGS
const char *password = "00000000";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.13.69/biometricattendance/getdata.php"; //computer IP or the server domain
